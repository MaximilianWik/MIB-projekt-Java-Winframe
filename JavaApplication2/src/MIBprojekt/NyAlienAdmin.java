 ...
 * @author Victus
 */
public class NyAlienAdmin extends javax.swing.JFrame {
     ...
     */
    public NyAlienAdmin(InfDB idb, int agentId) {
        initComponents();
        this.idb = idb;
    ...
    private void laggTillNyAlien() {
        ...
        try {
            ...
            Logger.getLogger(NyAlienAdmin.class.getName()).log(Level.SEVERE, null, ex);
